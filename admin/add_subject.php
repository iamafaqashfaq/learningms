		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										mysql_query("insert into subject (subject_code,subject_title,description,Credit_hour,semester) values('$subject_code','$title','$description','$Credit_hour','$semester')")or die(mysql_error());
